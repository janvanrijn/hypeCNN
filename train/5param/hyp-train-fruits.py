...
def get_hyperparameter_search_space(seed=None):
	...
	batch_size = ConfigSpace.CategoricalHyperparameter(
		name='batch_size', choices=[32, 64, 128], default_value=128)
...
def load_data(shuffle, batch_size):
	root = '/rigel/dsi/users/as5414/fruits/'
	...
	trainset = datasets.ImageFolder(root=root+'Training/', transform=transform_train)
