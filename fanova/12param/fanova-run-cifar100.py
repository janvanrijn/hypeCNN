...
plot_dir = path + '/data/cifar100/test_plots_'+response_type

# artificial dataset (here: features)
features = np.loadtxt(path + '/data/cifar100/cifar100-features.csv', delimiter=",")
responses = np.loadtxt(path + '/data/cifar100/cifar100-responses-'+response_type+'.csv', delimiter=",")
