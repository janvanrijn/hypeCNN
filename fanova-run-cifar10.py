...
plot_dir = path + '/data/cifar10/test_plots_'+response_type

# artificial dataset (here: features)
features = np.loadtxt(path + '/data/cifar10/cifar10-features.csv', delimiter=",")
responses = np.loadtxt(path + '/data/cifar10/cifar10-responses-'+response_type+'.csv', delimiter=",")
